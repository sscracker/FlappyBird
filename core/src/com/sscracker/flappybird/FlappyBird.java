package com.sscracker.flappybird;
...
public class FlappyBird extends ApplicationAdapter {
	...
	public void initGame(){
		...
		for (int i = 0; i < tubesNumber; i++)
		{
			...
			tubeShift[i] = (random.nextFloat() - 0.5f) * (Gdx.graphics.getHeight() - spaceBetweenTubes - 380);
	...
	public void render () {
		...
		score.draw(batch,String.valueOf(gameScore),50,150);
		batch.end();
